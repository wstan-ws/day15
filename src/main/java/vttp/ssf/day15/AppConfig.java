...
public class AppConfig {
    ...
    // Inject properties from application.properties into configuration
    ...
    public RedisTemplate<String, String> createRedisConnection() {
        ...
        // Only set the username and password if they are not set
        if (redisUsername.trim().equals("NOT SET")) {
            config.setUsername(redisUsername);
            config.setPassword(redisPassword);
        }

        logger.log(Level.INFO, "Using Redis port %d".formatted(redisPort));
